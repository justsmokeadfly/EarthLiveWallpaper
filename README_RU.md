...
- Режимы обоев: **Заполнить, Вписать, Растянуть, Замостить, По центру, На все мониторы**.

### 🔭 James Webb Fotos
- Свежие изображения из официального Flickr-альбома NASA Webb Telescope.
- Миниатюры для просмотра вместо загрузки полноразмерных изображений в галерею.
...
Сборки создаются автоматически через GitHub Actions из семантических тегов, например `v1.6.0`. Перед выпуском проходят Ruff, security-правила Ruff, mypy, pytest, PyInstaller и проверку установщика.
...
├── infrastructure/    # Спутниковые источники, NASA/Webb, загрузка и Win32
