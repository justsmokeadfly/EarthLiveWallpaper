...
_STRINGS: dict[Language, dict[str, str]] = {
    Language.EN: {
        ...
        "settings.title": "Settings", "settings.resolution": "Resolution", "settings.check_interval": "Check interval (hours)", "settings.history_size": "History size", "settings.theme": "Theme", "settings.language": "Language", "settings.autostart": "Launch at Windows login", "settings.wallpaper_mode": "Wallpaper mode", "settings.retry_count": "Retry count", "settings.retry_delay": "Retry delay (seconds)", "settings.space_mix": "Automatic Cosmic Mix", "settings.space_mix_interval": "Cosmic Mix interval (hours)", "settings.invalid_value": "Invalid value: {error}", "settings.save_failed": "Failed to save settings. Check logs.",
