...
_STRINGS: dict[Language, dict[str, str]] = {
    Language.EN: {
        ...
        "button.nasa_photos": "NASA Photos", "button.webb_photos": "James Webb Photos", "button.hubble_photos": "Hubble Photos", "button.space_mix": "🌌 Cosmic Mix", "button.space_mix_running": "🌌 Mixing...", "button.per_monitor": "🖥️ Per-monitor wallpapers",
        "space_mix.success": "Cosmic wallpaper applied!", "space_mix.failed": "Failed to update cosmic wallpaper.",
        "nasa_dialog.title.nasa": "NASA Photos", "nasa_dialog.title.webb": "James Webb Photos", "nasa_dialog.title.hubble": "Hubble Photos", "nasa_dialog.title.default": "Space Photos",
        "nasa_dialog.heading.nasa": "🚀 NASA Photos", "nasa_dialog.heading.webb": "🔭 James Webb Photos", "nasa_dialog.heading.hubble": "🛰️ Hubble Photos", "nasa_dialog.heading.default": "🌌 Space Photos",
        "nasa_dialog.search_placeholder": "Search by title and description…", "nasa_dialog.favorites_only": "⭐ Favorites",
        "size_picker.title": "Choose resolution", "size_picker.available_sizes": "Available sizes on Flickr:", "size_picker.continue": "Continue",
        "nasa_dialog.loading": "Loading photos…", "nasa_dialog.preview_loading": "Preview…", "nasa_dialog.preview_unavailable": "Preview unavailable",
        "nasa_dialog.open_image": "🔗 Open image", "nasa_dialog.source": "  ·  Source",
        "nasa_dialog.download": "Download", "nasa_dialog.install_wallpaper": "Set as wallpaper",
        "nasa_dialog.wallpaper_applied": "Wallpaper applied!", "nasa_dialog.wallpaper_apply_failed": "Failed to apply wallpaper.",
        "nasa_dialog.detecting_sizes": "Detecting available sizes…", "nasa_dialog.downloading": "Downloading…",
        "nasa_dialog.load_error": "Load error: {message}", "nasa_dialog.shown_count": "Showing: {shown} of {total}",
        "nasa_dialog.saved": "Saved: {name}", "nasa_dialog.download_error": "Download error: {message}",
        "nasa_dialog.resolution_pending": "Resolution: detecting…", "nasa_dialog.resolution": "Resolution: {width} × {height} ({megapixels} MP)",
    ...
    Language.RU: {
        ...
        "button.nasa_photos": "NASA Фото", "button.webb_photos": "Фото Джеймса Уэбба", "button.hubble_photos": "Фото Хаббла", "button.space_mix": "🌌 Космический микс", "button.space_mix_running": "🌌 Смешивание…", "button.per_monitor": "🖥️ Разные обои",
        "space_mix.success": "Космические обои установлены!", "space_mix.failed": "Не удалось обновить космические обои.",
        "nasa_dialog.title.nasa": "NASA Фото", "nasa_dialog.title.webb": "Фото Джеймса Уэбба", "nasa_dialog.title.hubble": "Фото Хаббла", "nasa_dialog.title.default": "Космические фото",
        "nasa_dialog.heading.nasa": "🚀 NASA Фото", "nasa_dialog.heading.webb": "🔭 Фото Джеймса Уэбба", "nasa_dialog.heading.hubble": "🛰️ Фото Хаббла", "nasa_dialog.heading.default": "🌌 Космические фото",
        "nasa_dialog.search_placeholder": "Поиск по названию и описанию…", "nasa_dialog.favorites_only": "⭐ Избранное",
        "size_picker.title": "Выбор разрешения", "size_picker.available_sizes": "Доступные размеры на Flickr:", "size_picker.continue": "Продолжить",
        "nasa_dialog.loading": "Загрузка фотографий…", "nasa_dialog.preview_loading": "Превью…", "nasa_dialog.preview_unavailable": "Превью недоступно",
        "nasa_dialog.open_image": "🔗 Открыть изображение", "nasa_dialog.source": "  ·  Источник",
        "nasa_dialog.download": "Скачать", "nasa_dialog.install_wallpaper": "Установить как обои",
        "nasa_dialog.wallpaper_applied": "Обои установлены!", "nasa_dialog.wallpaper_apply_failed": "Не удалось установить обои.",
        "nasa_dialog.detecting_sizes": "Определяю доступные размеры…", "nasa_dialog.downloading": "Скачивание…",
        "nasa_dialog.load_error": "Ошибка загрузки: {message}", "nasa_dialog.shown_count": "Показано: {shown} из {total}",
        "nasa_dialog.saved": "Сохранено: {name}", "nasa_dialog.download_error": "Ошибка скачивания: {message}",
        "nasa_dialog.resolution_pending": "Разрешение: определяется…", "nasa_dialog.resolution": "Разрешение: {width} × {height} ({megapixels} Мп)",
