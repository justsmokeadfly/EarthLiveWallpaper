...
_STRINGS: dict[Language, dict[str, str]] = {
    Language.EN: {
        ...
        "app_subtitle": "Live Earth wallpaper",
        ...
        "button.wallpapers": "Wallpapers",
        "wallpapers.title": "Wallpapers",
        "wallpapers.empty": "No wallpapers saved yet.",
        "wallpapers.apply": "Apply",
        "wallpapers.applied": "Applied!",
        "wallpapers.apply_failed": "Could not apply: {name}",
        "wallpapers.delete": "Delete",
        "wallpapers.delete_confirm": "Confirm delete",
        "wallpapers.deleted": "Deleted.",
        "wallpapers.delete_failed": "Could not delete: {name}",
        "wallpapers.create_timelapse": "Create timelapse (GIF)",
        "wallpapers.creating_timelapse": "Creating timelapse...",
        "wallpapers.timelapse_success": "Timelapse saved to {path}",
        "wallpapers.timelapse_failed": "Failed to create timelapse. Need at least 2 images in history.",
        "wallpapers.close": "Close",
        "wallpaper_mode.fill": "Fill",
        "wallpaper_mode.fit": "Fit",
        "wallpaper_mode.stretch": "Stretch",
        "wallpaper_mode.tile": "Tile",
        "wallpaper_mode.center": "Center",
        "wallpaper_mode.span": "Span (all monitors)",
        "theme.dark": "Dark",
        "theme.light": "Light",
        "theme.system": "System",
        ...
        "about.open_github": "Open on GitHub ↗",
        "about.close": "Close",
    ...
    Language.RU: {
        ...
        "button.wallpapers": "Обои",
        "wallpapers.title": "Обои",
        "wallpapers.empty": "Пока нет сохранённых обоев.",
        "wallpapers.apply": "Применить",
        "wallpapers.applied": "Применено!",
        "wallpapers.apply_failed": "Не удалось применить: {name}",
        "wallpapers.delete": "Удалить",
        "wallpapers.delete_confirm": "Точно удалить?",
        "wallpapers.deleted": "Удалено.",
        "wallpapers.delete_failed": "Не удалось удалить: {name}",
        "wallpapers.create_timelapse": "Создать таймлапс (GIF)",
        "wallpapers.creating_timelapse": "Создание таймлапса...",
        "wallpapers.timelapse_success": "Таймлапс сохранён: {path}",
        "wallpapers.timelapse_failed": "Не удалось создать таймлапс. Нужно минимум 2 изображения в истории.",
        "wallpapers.close": "Закрыть",
        "wallpaper_mode.fill": "Заполнение",
        "wallpaper_mode.fit": "По размеру экрана",
        "wallpaper_mode.stretch": "Растянуть",
        "wallpaper_mode.tile": "Плитка",
        "wallpaper_mode.center": "По центру",
        "wallpaper_mode.span": "На весь экран (все мониторы)",
        "theme.dark": "Тёмная",
        "theme.light": "Светлая",
        ...
        "about.open_github": "Открыть на GitHub ↗",
        "about.close": "Закрыть",
