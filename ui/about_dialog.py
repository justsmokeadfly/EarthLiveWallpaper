...
class AboutDialog(ctk.CTkToplevel):
    ...
    def _build_widgets(self) -> None:
        ...
        ctk.CTkLabel(
            self,
            text=self._tr.get("about.description"),
            font=(theme.FONT_FAMILY, theme.FONT_SIZE_BODY),
            text_color=theme.COLOR_TEXT_PRIMARY,
            wraplength=390,
            justify="center",
        ).pack(padx=24, pady=(8, 18))
    ...
    def _add_info_row(self, parent: ctk.CTkBaseClass, label: str, value: str) -> None:
        ...
        ctk.CTkLabel(row, text=label, font=(theme.FONT_FAMILY, theme.FONT_SIZE_BODY), text_color=theme.COLOR_TEXT_SECONDARY, anchor="w").pack(side="left")
